module ReceiveSubmissionJobHelper
  require "aws-sdk-sqs"
  require "aws-sdk-sts"
  ...
  included do
    def perform
      ...
      queue_url = build_queue_url(sts_client)
...
private
  ...
  def build_queue_url(sts_client)
    "https://sqs.#{REGION}.amazonaws.com/#{sts_client.get_caller_identity.account}/#{self.class::SQS_QUEUE_NAME}"
  end
  ...
  def process_messages(sqs_client, queue_url, messages)
    messages.each do |message|
      ...
      process_ses_event(ses_event_type, submission)
