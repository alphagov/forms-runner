class FormSubmissionService
  ...
  def initialize(logging_context:, current_context:, email_confirmation_form:, preview_mode:)
...
private
  ...
  def email_body
    NotifyTemplateBodyFilter.new.build_question_answers_section(@current_context)
  end
