  ...
  module SelectionComponent
    ...
    private
      ...
      def none_of_the_above_radio_button
        ...
        option = form_builder.govuk_radio_button :selection, Question::Selection::NONE_OF_THE_ABOVE_VALUE, label: { text: I18n.t("page.none_of_the_above") }
      ...
      def none_of_the_above_checkbox
        ...
        option = form_builder.govuk_check_box :selection, Question::Selection::NONE_OF_THE_ABOVE_VALUE, exclusive: true, label: { text: I18n.t("page.none_of_the_above") }
        safe_join([divider, option])
      end
