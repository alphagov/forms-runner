...
RSpec.describe Form, type: :model do
  ...
  describe "what_happens_next_markdown" do
    ...
    it "returns the text in notify-compliant markdown format" do
      expect(described_class.find(1).what_happens_next_markdown).to eq "We’ll send you an email to let you know the outcome. Visit our [service status page](https://example.com) to see current response times.\n\nYou'll also need to:\n\n- provide a certified copy of your documents\n- make a payment"
    end
  end
end
